 ...
 * Networking module
 * ap_net/conn_pool_set_str_addr.c
 */
...
*/
int ap_net_conn_pool_set_str_addr(int af, void *destination, const char *address_str, socklen_t addr_len, int port)
{
	const char *_func_name = "ap_net_conn_pool_set_str_addr()";
...
*/
int ap_net_conn_pool_set_ip4_addr(struct sockaddr_in *destination, in_addr_t address4, int port)
{
...
*/
int ap_net_conn_pool_set_ip6_addr(struct sockaddr_in6 *destination, struct in6_addr *address6, int port)
{
	if ( port <= 0 || port > 65535 )
    {
